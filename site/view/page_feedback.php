...
<div class="container mt-4">
    ...
    <div>
        <div class="d-flex align-items-center">
            ...
            <?php if(isset($_SESSION['user']) && $_SESSION['user']['MaKhachHang'] == $feedback['MaKhachHang']): ?>
                <a href="?mod=product&act=edit&id=<?=$feedback['MaBinhLuan']?>" class="btn btn-warning btn-sm ms-2">Chỉnh sửa</a>
        <?php endif; ?>
